...
public class TodayGoodsTypeSalesBestDetailAdapter extends RecyclerView.Adapter<TodayGoodsTypeSalesBestDetailAdapter.SaleHolder> {
    private List<GoodsTypeDetail.ProductListBean> list;
    private Context context;
    private LayoutInflater layoutInflater;

    public TodayGoodsTypeSalesBestDetailAdapter(List<GoodsTypeDetail.ProductListBean> list, Context context) {
        this.list = list;
